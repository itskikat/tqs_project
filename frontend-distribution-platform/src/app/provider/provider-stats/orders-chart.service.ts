...
@Injectable()
export class OrdersChartServiceProvider extends OrdersChartData {
  ...
  private getDataForWeekPeriod(): OrdersChart {
    return {
      chartLabel: this.getDataLabels(42, ['1','2','3','4','5']),
      linesData: [
        [
  ...
  private getDataForMonthPeriod(): OrdersChart {
    return {
      chartLabel: this.getDataLabels(47, ['2','3']),
      linesData: [
        [
  ...
  private getDataForYearPeriod(): OrdersChart {
    return {
      chartLabel: this.getDataLabels(42, ['2','3']),
      linesData: [
        [
  ...
  private getProviderDataForWeekPeriod(): OrdersChart {
    return {
      chartLabel: this.getDataLabels(42, ['2','3']),
      linesData: [
        [
        ...
        [
          18, 178, 193, 205, 212, 213,
          24, 190, 180, 173, 168, 164,
          12, 160, 159, 158, 159, 166,
          19, 195, 215, 236, 257, 276,
          22, 301, 304, 303, 300, 293,
          24, 273, 262, 251, 241, 234,
          232, 232, 232, 232, 232, 232,
        ],
        [
          58, 137, 202, 251, 288, 312,
  ...
  private getProviderDataForMonthPeriod(): OrdersChart {
    return {
      chartLabel: this.getDataLabels(47, ['2','3']),
      linesData: [
        [
  ...
  private getProviderDataForYearPeriod(): OrdersChart {
    return {
  ...
  getOrdersChartData(period: string, provider?:boolean): OrdersChart {
    if (provider){
